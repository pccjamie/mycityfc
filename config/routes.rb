...
devise_for :users, :controllers => { :omniauth_callbacks => "users/omniauth_callbacks", :profiles => "users/profiles" }
...
# 	# get 'account_update', :to => 'users#edit'
...
get "users/edit", :to => "users/profiles#edit"
